...
const Alltask = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://todo-be-mhvd.onrender.com/taskRouter/?priority=${filterPriority}&category=${filterCategory}`
      )
      .then((response) => {
  ...
  const handleDelete = async (taskId) => {
    ...
    setError(null);
    try {
      await axios.delete(`https://todo-be-mhvd.onrender.com/taskRouter/delete/${taskId}`);
  ...
  return (
    <div className="container mx-auto">
      <h1 className="text-2xl font-bold mb-4">All Todo</h1>
      {loading && <p>Loading...</p>}
      {error && <p>{error}</p>}
